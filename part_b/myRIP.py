...
class Topology(Topo):
    def build(self, **_opts):
        # create router nodes
        r1 = self.addNode('R1', cls=MyRouter, ip=None)
        r2 = self.addNode('R2', cls=MyRouter, ip=None)
        r3 = self.addNode('R3', cls=MyRouter, ip=None)
        r4 = self.addNode('R4', cls=MyRouter, ip=None)
        ...
        # r4 = self.addNode(router4['name'], cls=MyRouter, ip=None)
        #
        # # create host nodes
